#############################################################################
# Makefile for building: biblioteca_virtuale.app/Contents/MacOS/biblioteca_virtuale
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  biblioteca_virtuale.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile biblioteca_virtuale.pro
#############################################################################
...
INCPATH       = -I. -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/System/Library/Frameworks/AGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
DISTDIR = /Users/andreamasiero/Downloads/biblioteca_virtuale/.tmp/biblioteca_virtuale1.0.0
...
SOURCES       = main.cpp \
		...
		persistence/JsonSerializer.cpp moc_MainWindow.cpp \
		moc_LoginDialog.cpp \
		moc_MediaWidgetVisitor.cpp \
		moc_AddMediaDialog.cpp \
		moc_EditMediaDialog.cpp
OBJECTS       = main.o \
		Media.o \
		Book.o \
		Film.o \
		...
		MainWindow.o \
		LoginDialog.o \
		MediaWidgetVisitor.o \
		AddMediaDialog.o \
		EditMediaDialog.o \
		MediaCollectorVisitor.o \
		JsonSerializer.o \
		moc_MainWindow.o \
		moc_LoginDialog.o \
		moc_MediaWidgetVisitor.o \
		moc_AddMediaDialog.o \
		moc_EditMediaDialog.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		biblioteca_virtuale.pro model/Media.h \
		model/Book.h \
		model/Film.h \
		...
		persistence/JsonSerializer.h main.cpp \
		model/Media.cpp \
		model/Book.cpp \
		model/Film.cpp \
		model/MagazineArticle.cpp \
...
DESTDIR       = 
TARGET        = biblioteca_virtuale.app/Contents/MacOS/biblioteca_virtuale

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/andreamasiero/Downloads/biblioteca_virtuale/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/andreamasiero/Downloads/biblioteca_virtuale/biblioteca_virtuale.pro
...
biblioteca_virtuale.app/Contents/MacOS/biblioteca_virtuale:  $(OBJECTS)  
	@test -d biblioteca_virtuale.app/Contents/MacOS/ || mkdir -p biblioteca_virtuale.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: biblioteca_virtuale.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
biblioteca_virtuale.app/Contents/PkgInfo: 
	@test -d biblioteca_virtuale.app/Contents || mkdir -p biblioteca_virtuale.app/Contents
	@$(DEL_FILE) biblioteca_virtuale.app/Contents/PkgInfo
	@echo "APPL????" > biblioteca_virtuale.app/Contents/PkgInfo
biblioteca_virtuale.app/Contents/Info.plist: 
	@test -d biblioteca_virtuale.app/Contents || mkdir -p biblioteca_virtuale.app/Contents
	@$(DEL_FILE) biblioteca_virtuale.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,andrea.biblioteca-virtuale,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},andrea.biblioteca-virtuale,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,biblioteca_virtuale,g" -e "s,@LIBRARY@,biblioteca_virtuale,g" -e "s,\$${EXECUTABLE_NAME},biblioteca_virtuale,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >biblioteca_virtuale.app/Contents/Info.plist

all: Makefile \
		biblioteca_virtuale.app/Contents/PkgInfo \
		biblioteca_virtuale.app/Contents/Info.plist biblioteca_virtuale.app/Contents/MacOS/biblioteca_virtuale
...
distdir: FORCE
	...
	$(COPY_FILE) --parents model/Media.h model/Book.h model/Film.h model/MagazineArticle.h model/MediaVisitor.h model/Biblioteca.h model/User.h model/UserAuthenticator.h model/Container.h model/Exceptions.h model/MediaFactory.h view/MainWindow.h view/LoginDialog.h view/MediaWidgetVisitor.h view/AddMediaDialog.h view/EditMediaDialog.h view/MediaCollectorVisitor.h persistence/JsonSerializer.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp model/Media.cpp model/Book.cpp model/Film.cpp model/MagazineArticle.cpp model/Biblioteca.cpp model/User.cpp model/UserAuthenticator.cpp model/MediaFactory.cpp view/MainWindow.cpp view/LoginDialog.cpp view/MediaWidgetVisitor.cpp view/AddMediaDialog.cpp view/EditMediaDialog.cpp view/MediaCollectorVisitor.cpp persistence/JsonSerializer.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r biblioteca_virtuale.app
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_LoginDialog.cpp moc_MediaWidgetVisitor.cpp moc_AddMediaDialog.cpp moc_EditMediaDialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_LoginDialog.cpp moc_MediaWidgetVisitor.cpp moc_AddMediaDialog.cpp moc_EditMediaDialog.cpp
moc_MainWindow.cpp: view/MainWindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/andreamasiero/Downloads/biblioteca_virtuale/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/andreamasiero/Downloads/biblioteca_virtuale -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib view/MainWindow.h -o moc_MainWindow.cpp

moc_LoginDialog.cpp: view/LoginDialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLineEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlineedit.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/andreamasiero/Downloads/biblioteca_virtuale/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/andreamasiero/Downloads/biblioteca_virtuale -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib view/LoginDialog.h -o moc_LoginDialog.cpp

moc_MediaWidgetVisitor.cpp: view/MediaWidgetVisitor.h \
		model/MediaVisitor.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		model/Media.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/andreamasiero/Downloads/biblioteca_virtuale/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/andreamasiero/Downloads/biblioteca_virtuale -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib view/MediaWidgetVisitor.h -o moc_MediaWidgetVisitor.cpp

moc_AddMediaDialog.cpp: view/AddMediaDialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLineEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlineedit.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/andreamasiero/Downloads/biblioteca_virtuale/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/andreamasiero/Downloads/biblioteca_virtuale -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib view/AddMediaDialog.h -o moc_AddMediaDialog.cpp

moc_EditMediaDialog.cpp: view/EditMediaDialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLineEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlineedit.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/andreamasiero/Downloads/biblioteca_virtuale/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/andreamasiero/Downloads/biblioteca_virtuale -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib view/EditMediaDialog.h -o moc_EditMediaDialog.cpp
...
Media.o: model/Media.cpp model/Media.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QJsonObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qjsonobject.h \
		...
		model/Film.h \
		model/MagazineArticle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Media.o model/Media.cpp

Book.o: model/Book.cpp model/Book.h \
		model/Media.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QJsonObject \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Book.o model/Book.cpp
...
MagazineArticle.o: model/MagazineArticle.cpp model/MagazineArticle.h \
		model/Media.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QJsonObject \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MagazineArticle.o model/MagazineArticle.cpp

Biblioteca.o: model/Biblioteca.cpp model/Biblioteca.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QList \
		/opt/homebrew/lib/QtCore.framework/Headers/qlist.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		...
		model/MagazineArticle.h \
		view/MediaCollectorVisitor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Biblioteca.o model/Biblioteca.cpp
...
UserAuthenticator.o: model/UserAuthenticator.cpp model/UserAuthenticator.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QList \
		/opt/homebrew/lib/QtCore.framework/Headers/qlist.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UserAuthenticator.o model/UserAuthenticator.cpp

MediaFactory.o: model/MediaFactory.cpp model/MediaFactory.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QJsonObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qjsonobject.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MediaFactory.o model/MediaFactory.cpp
...
LoginDialog.o: view/LoginDialog.cpp view/LoginDialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLineEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlineedit.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/qapplication.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o LoginDialog.o view/LoginDialog.cpp

MediaWidgetVisitor.o: view/MediaWidgetVisitor.cpp view/MediaWidgetVisitor.h \
		model/MediaVisitor.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		model/Media.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MediaWidgetVisitor.o view/MediaWidgetVisitor.cpp

AddMediaDialog.o: view/AddMediaDialog.cpp view/AddMediaDialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLineEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlineedit.h \
		...
		/opt/homebrew/lib/QtGui.framework/Headers/QPixmap \
		/opt/homebrew/lib/QtGui.framework/Headers/qpixmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AddMediaDialog.o view/AddMediaDialog.cpp

EditMediaDialog.o: view/EditMediaDialog.cpp view/EditMediaDialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLineEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlineedit.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QFileInfo \
		/opt/homebrew/lib/QtCore.framework/Headers/qfileinfo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EditMediaDialog.o view/EditMediaDialog.cpp

MediaCollectorVisitor.o: view/MediaCollectorVisitor.cpp view/MediaCollectorVisitor.h \
		model/MediaVisitor.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		model/Biblioteca.h \
		...
		model/Film.h \
		model/MagazineArticle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MediaCollectorVisitor.o view/MediaCollectorVisitor.cpp

JsonSerializer.o: persistence/JsonSerializer.cpp persistence/JsonSerializer.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QJsonObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qjsonobject.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o JsonSerializer.o persistence/JsonSerializer.cpp
...
moc_MediaWidgetVisitor.o: moc_MediaWidgetVisitor.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_MediaWidgetVisitor.o moc_MediaWidgetVisitor.cpp

moc_AddMediaDialog.o: moc_AddMediaDialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_AddMediaDialog.o moc_AddMediaDialog.cpp

moc_EditMediaDialog.o: moc_EditMediaDialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_EditMediaDialog.o moc_EditMediaDialog.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin || mkdir -p $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin/biblioteca_virtuale.app
	
	$(QINSTALL) biblioteca_virtuale.app $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin/biblioteca_virtuale.app
	-$(STRIP) $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin/biblioteca_virtuale.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin/biblioteca_virtuale.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/biblioteca_virtuale/bin/ 
